...
| ------------------------- | ----------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- |
| **_Logo_**                |                                                             | ![BeCode](Imagenes/Logo_BeCode.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | ![Upwork](Imagenes/upwork.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | ![fiverr](Imagenes/fiverr.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | ![Toptal](Imagenes/Toptal_Logo.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |     |
...
| Sprint 3 Velocity                  | Se tomo en cuenta la creacion de todos los contextos, en este caso 5 Historias de usuario por contexto                                                                                                                                                                                                                                                                                                                 |
| Sum of Story Points                | Se completaron las 5 historias de usuario.                                                                                                                                                                                                                                                                                                                                                                             |
...
Aqui se presentan los commits hechos en el repositorio del backend:

| Repository                                                                             | Branch                             | Commit ID | Commit Message                                                                      | Commit Message Body | Committed on (Date) |
| -------------------------------------------------------------------------------------- | ---------------------------------- | --------- | ----------------------------------------------------------------------------------- | ------------------- | ------------------- |
| [https://github.com/G5-Open-Source/backend](https://github.com/G5-Open-Source/backend) | -                                  | 623x324   | fix(pom.xml)                                                                        | -                   | Jun 20, 2025        |
| [https://github.com/G5-Open-Source/backend](https://github.com/G5-Open-Source/backend) | origin/Subscription-context-(Kael) | 6469345   | Merge remote-tracking branch 'origin/Subscription-context-(Kael)'                   | -                   | Jun 20, 2025        |
| [https://github.com/G5-Open-Source/backend](https://github.com/G5-Open-Source/backend) | -                                  | 94118a8   | fix(UserContext): Fixed logic errors in Entities and controller                     | -                   | Jun 20, 2025        |
| [https://github.com/G5-Open-Source/backend](https://github.com/G5-Open-Source/backend) | -                                  | ca:c7fa9  | feat(message) project): Implementar lógica de dominio y persistencia                | -                   | Jun 19, 2025        |
| [https://github.com/G5-Open-Source/backend](https://github.com/G5-Open-Source/backend) | -                                  | 6686ead   | feat(message) project): Implementar lógica de dominio y persistencia                | -                   | Jun 19, 2025        |
| [https://github.com/G5-Open-Source/backend](https://github.com/G5-Open-Source/backend) | -                                  | 19864fa   | Archivos pertenecientes al Subscription context                                     | Verified            | Jun 18, 2025        |
| [https://github.com/G5-Open-Source/backend](https://github.com/G5-Open-Source/backend) | -                                  | 764ac5c   | feat(user): added application, interface and infrastructure                         | -                   | Jun 14, 2025        |
| [https://github.com/G5-Open-Source/backend](https://github.com/G5-Open-Source/backend) | -                                  | 7299613   | feat: Added User Context. Needs Services, Application, Infrastructure and interface | -                   | Jun 13, 2025        |
| [https://github.com/G5-Open-Source/backend](https://github.com/G5-Open-Source/backend) | -                                  | 4728446   | feat: added shared context                                                          | -                   | Jun 7, 2025         |

#### 5.2.3.5. Execution Evidence for Sprint Review.

Aqui se demuestra la ejecucion de la API y creacion de la base de datos:

![execution-sprint3](Imagenes/sprint3-execution1.png)
...
| ------------------ | ---------------------- | -------------------------------------------------------------------------- | ----------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| users              | GET                    | `` const response = await axios.get(`${UsersAPI}`); ``                     | Ninguno                                                           | `` const response = await axios.get(`${UsersAPI}`); ``                                                               | Retorna todos los usuarios registrados                  |
| users              | POST                   | `` const response = await axios.post(`${UsersAPI}`, user); ``              | `user` debe contener datos como nombre, correo, contraseña, etc.  | `` const response = await axios.post(`${UsersAPI}`, { name: "Luis", email: "luis@mail.com", password: "1234" }); ``  | Crea un nuevo usuario y devuelve sus datos              |
| users              | PUT                    | `` const response = await axios.put(`${UsersAPI}/${userId}`, data); ``     | `userId` es requerido, `data` incluye campos a modificar          | `` const response = await axios.put(`${UsersAPI}/1`, { name: "Luis P." }); ``                                        | Actualiza los datos del usuario                         |
| users              | DELETE                 | `` const response = await axios.delete(`${UsersAPI}/${userId}`); ``        | `userId` es requerido                                             | `` const response = await axios.delete(`${UsersAPI}/1`); ``                                                          | Elimina el usuario correspondiente                      |
| companies          | GET                    | `` const response = await axios.get(`${CompaniesAPI}`); ``                 | Ninguno                                                           | `` const response = await axios.get(`${CompaniesAPI}`); ``                                                           | Retorna todas las compañías registradas                 |
| companies          | POST                   | `` const response = await axios.post(`${CompaniesAPI}`, company); ``       | `company` debe incluir nombre, rubro y contacto                   | `` const response = await axios.post(`${CompaniesAPI}`, { name: "TechCorp", industry: "IT" }); ``                    | Crea una nueva compañía                                 |
| companies          | PUT                    | `` const response = await axios.put(`${CompaniesAPI}/${id}`, update); ``   | `id` requerido, `update` con los nuevos valores                   | `` const response = await axios.put(`${CompaniesAPI}/2`, { name: "TechCorp Perú" }); ``                              | Actualiza la información de la compañía                 |
| companies          | DELETE                 | `` const response = await axios.delete(`${CompaniesAPI}/${id}`); ``        | `id` requerido                                                    | `` const response = await axios.delete(`${CompaniesAPI}/2`); ``                                                      | Elimina la compañía especificada                        |
| projects           | GET                    | `` const response = await axios.get(`${ProjectsAPI}`); ``                  | Ninguno                                                           | `` const response = await axios.get(`${ProjectsAPI}`); ``                                                            | Retorna todos los proyectos creados                     |
| projects           | POST                   | `` const response = await axios.post(`${ProjectsAPI}`, project); ``        | `project` con título, descripción y requisitos                    | `` const response = await axios.post(`${ProjectsAPI}`, { title: "App Web", description: "Proyecto Vue + .NET" }); `` | Crea un nuevo proyecto                                  |
| projects           | PUT                    | `` const response = await axios.put(`${ProjectsAPI}/${id}`, data); ``      | `id` del proyecto, `data` con información actualizada             | `` const response = await axios.put(`${ProjectsAPI}/5`, { title: "App Web FullStack" }); ``                          | Actualiza los datos del proyecto                        |
| projects           | DELETE                 | `` const response = await axios.delete(`${ProjectsAPI}/${id}`); ``         | `id` del proyecto                                                 | `` const response = await axios.delete(`${ProjectsAPI}/5`); ``                                                       | Elimina el proyecto correspondiente                     |
| messages           | GET                    | `` const response = await axios.get(`${MessagesAPI}`); ``                  | Ninguno                                                           | `` const response = await axios.get(`${MessagesAPI}`); ``                                                            | Retorna todos los mensajes                              |
| messages           | POST                   | `` const response = await axios.post(`${MessagesAPI}`, msg); ``            | `msg` debe contener de, para, y contenido                         | `` const response = await axios.post(`${MessagesAPI}`, { from: 1, to: 2, text: "Hola" }); ``                         | Envía un nuevo mensaje                                  |
| messages           | PUT                    | `` const response = await axios.put(`${MessagesAPI}/${id}`, update); ``    | `id` del mensaje, `update` con el nuevo contenido                 | `` const response = await axios.put(`${MessagesAPI}/3`, { text: "Nuevo mensaje" }); ``                               | Actualiza el mensaje                                    |
| messages           | DELETE                 | `` const response = await axios.delete(`${MessagesAPI}/${id}`); ``         | `id` del mensaje                                                  | `` const response = await axios.delete(`${MessagesAPI}/3`); ``                                                       | Elimina el mensaje especificado                         |
| subscriptions      | GET                    | `` const response = await axios.get(`${SubscriptionsAPI}`); ``             | Ninguno                                                           | `` const response = await axios.get(`${SubscriptionsAPI}`); ``                                                       | Retorna todos los planes de suscripción                 |
| subscriptions      | POST                   | `` const response = await axios.post(`${SubscriptionsAPI}`, plan); ``      | `plan` debe incluir tipo, duración y precio                       | `` const response = await axios.post(`${SubscriptionsAPI}`, { type: "Premium", duration: "1m", price: 19.99 }); ``   | Crea un nuevo plan de suscripción                       |
| subscriptions      | PUT                    | `` const response = await axios.put(`${SubscriptionsAPI}/${id}`, data); `` | `id` requerido, `data` con cambios                                | `` const response = await axios.put(`${SubscriptionsAPI}/2`, { price: 24.99 }); ``                                   | Actualiza el plan especificado                          |
| subscriptions      | DELETE                 | `` const response = await axios.delete(`${SubscriptionsAPI}/${id}`); ``    | `id` del plan                                                     | `` const response = await axios.delete(`${SubscriptionsAPI}/2`); ``                                                  | Elimina el plan correspondiente                         |
| search/freelancers | GET                    | `` const response = await axios.get(`${SearchAPI}/freelancers`); ``        | Parámetros opcionales por query string: `skill`, `location`, etc. | `` const response = await axios.get(`${SearchAPI}/freelancers?skill=vue&location=peru`); ``                          | Retorna lista de freelancers filtrados según parámetros |
...
Validar la usabilidad, claridad y funcionalidad de la aplicación _BeCode_ en distintos perfiles de usuario, evaluando si los flujos de interacción fueron fáciles de entender, y si la interfaz resultó intuitiva y útil para comunicarse entre desarrolladores e inversores .
...
Link de la entrevista: [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202210104_upc_edu_pe/EU2OCSBHNe5AuEfPqmiNRHQB1X9YaGOMdLb5XppgRJFESQ?e=1SeFPr&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202210104_upc_edu_pe/EU2OCSBHNe5AuEfPqmiNRHQB1X9YaGOMdLb5XppgRJFESQ?e=1SeFPr&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D)

## Entrevista 2:

Nombre: Arturo Salinas

Capturas: ![sprint-3-entrevista](Imagenes/Entrevista2-sprint-3.png)

Descripción: Una entrevista al Señor Arturo Salinas, gestor de proyectos, que nos comenta un poco mas acerca de lo visto en la aplicacion web, en especifo del Frontend. Menciona algunas mejoreas qu debemos tomar en cuenta gracias a las preguntas realizadas y genera un feedback adecuado que nos ayudara a lograr la mayor satisfaccion para nuestros usuarios.

Link de la entrevista: [https://drive.google.com/file/d/1CjLVcuL0kAZDZ752CeG4ybctViZ--aQj/view?usp=sharing](https://drive.google.com/file/d/1CjLVcuL0kAZDZ752CeG4ybctViZ--aQj/view?usp=sharing)
